    ...
    render: function() {
        ...
        return (
            <div className={ className } style={ style }>
                ...
                <p>This site was created using React, SASS, Lodash, and build with Gulp. The animation is all css, no jQuery. <a href="https://github.com/ipsofatso/ipsofatso.com-v6">Source code</a></p>
            </div>
        );
    }
});
